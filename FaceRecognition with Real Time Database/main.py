...
while True:
    ...
    imgS=cv2.cvtColor(imgS,cv2.COLOR_BGR2RGB) #opencv uses BGR but face_recognition uses RGB
            ...
            if counter !=0:
                ...
                if counter == 1:
                    ...
                    if secondElapsed >30:
                        ...
                        ref.child("last_attendance_time").set(datetime.now().strftime("%B %d, %Y %H:%M:%S"))
                    else:
                        modeType = 3
                        counter = 0
                        imgBackground[44:44+633 ,808:808+414]= imgModeList[modeType]
